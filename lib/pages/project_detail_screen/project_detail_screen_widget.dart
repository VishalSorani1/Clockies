                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        fillColor: (_model
                                    .descriptionTextFieldFocusNode?.hasFocus ??
                                false)
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                        _model.clientDropDownValueController ??=
                                            FormFieldController<String>(
                                      _model.clientDropDownValue ??= widget
                                          .projectDetail?.clients.clientName,
                                    ),
                                    options: FFAppState()
                                        .clientData
                                        .map((e) => e.clientName)
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    focusNode:
                                        _model.totalHourseTextFieldFocusNode,
                                    onFieldSubmitted: (_) async {
                                      await Future.delayed(
                                          const Duration(milliseconds: 100));
                                      await _model.updateProjectDetail(context);
                                ...
                                Expanded(
                                  child: Theme(
                                    ...
                                    child: CheckboxListTile(
                                      value: _model.excessHoursValue ??= widget
                                              .projectDetail?.allowOverSpent ==
                                          1,
                              ...
                              children: [
                                Expanded(
                                  child: Theme(
                                    ...
                                    child: CheckboxListTile(
                                      value: _model.taskEntryValue ??= widget
                                              .projectDetail?.allowManualTask ==
                                          1,
                                      onChanged: !_model.hasProjectEditRole
                                          ? null
                                          : (newValue) async {
                                              setState(() => _model
                                                  .taskEntryValue = newValue!);
                                              if (newValue!) {
                                                await Future.delayed(
                                                    const Duration(
                                                        milliseconds: 100));
